...
const CartItem = ({item, cantidad, img}) => {
    ...
    return (
        ...
        <div className="cardProdCart">
            <div className="contImgProdCart" >
                <div className="imgProdCart"  style={back}></div>
            </div>
            <div className="detProdCart">
                    <div>
                        <h4>{item.nom}</h4>
                        <p>Cantidad: {cantidad}</p>
                        <p>Precio/u ${item.precio}.-</p>
                    </div>
                <div className="btnProdCart">
                <button class="btnBorrar" onClick={()=>delProd(item.itemId)}>
